...
const SvgMoreOptions = () => {
    return (
        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M7.5625 5.5H18.5625" stroke="black" stroke-width="2" stroke-linecap="round"
                  stroke-linejoin="round"/>
            <path d="M7.56299 11H18.5625" stroke="black" stroke-width="2" stroke-linecap="round"
                  stroke-linejoin="round"/>
            <path d="M7.56299 16.5H18.5625" stroke="black" stroke-width="2" stroke-linecap="round"
                  stroke-linejoin="round"/>
            <path
